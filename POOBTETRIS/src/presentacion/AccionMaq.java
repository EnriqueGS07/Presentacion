...
public class AccionMaq extends Thread {

    //PANEL GAME
    PanelGameMaq panelGame;
    ...
    /**
     * Constructor de la clase AccionMaq
     * @param panel PanelGameMaq
     * @param tablero Tablero del Juego
     * @param numTablero Numero de Tablero
     */
    public AccionMaq(PanelGameMaq panel, Tablero tablero, int numTablero) {
        ...
        running = true;
         maquina = new Maquina(tablero.getTetris());
    }
        ...
        try {
            while (running) {
                ...
                if(!tablero.gameOver()){
                    ...
                    System.out.println("TERMINO MAQ " + numTablero + "");
                    panelGame.stopGame();
