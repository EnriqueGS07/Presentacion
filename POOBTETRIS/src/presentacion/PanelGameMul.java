...
public class PanelGameMul{
    ...
    private JPanel menupanelGameMul;
    ...
    /* GAME */
    private AccionMul game1;
    private AccionMul game2;
    ...
    /**
     * Constructor de la Clase PanelGameMul
     * @param gui Gui
     * @param panelGame PanelGame
     */
    public PanelGameMul(TetrisGUI gui, PanelGame panelGame) {
     ...
     */
    public PanelGameMul(TetrisGUI gui, PanelGame panelGame, ArrayList<String> datos) {
        this.panelGame = panelGame;
        this.gui = gui;
        prepareElementos();
        prepareAcciones();
    ...
    public void prepareStartGame() {
        this.game1 = new AccionMul(this,tablero1,1);
        this.game2 = new AccionMul(this,tablero2,2);
    ...
    public void prepareElementos() {
        ...
        menupanelGameMul = new JPanel();
        menupanelGameMul.setLayout(null);
        gui.getMainPanel().add(menupanelGameMul, "menuModoMul");
        //BOTONES
        ...
        menupanelGameMul.add(botonConfig);
        //PAUSA
        ...
        menupanelGameMul.add(botonPausa);
        //NOMBRE 1
        name1 = new JLabel();
        ...
        menupanelGameMul.add(textLevel);
        //Time 1
        ...
        menupanelGameMul.add(textTime1);
        //Score 1
        ...
        menupanelGameMul.add(textScore1);
        //Time 2
        ...
        menupanelGameMul.add(textTime2);
        //Score 2
        ...
        menupanelGameMul.add(textScore2);
        //TABLERO
        ...
        menupanelGameMul.add(panel1);
        menupanelGameMul.add(panel2);
        //FICHAS
    ...
    public void prepareAcciones() {
        MouseListener mouseListenerGameMul = new MouseListener() {
            @Override
        ...
        botonPausa.addMouseListener(mouseListenerGameMul);
        botonConfig.addMouseListener(mouseListenerGameMul);
    }
    ...
    public void setColor2(String strColor) {
        ...
        panelGame.setChangeColor2(new Color(Integer.parseInt(c[0]),Integer.parseInt(c[1]),Integer.parseInt(c[2]),Integer.parseInt(c[3])));
    }
    ...
    /**
     * Metodo que retorna el time del jugador 1
     * @return Time 1
     */
    ...
    /**
     * Metodo que retorna el Score del jugador 1
     * @return Score 1
     */
    ...
    /**
     * Metodo que retorna el time del jugador 2
     * @return Time 2
     */
    ...
    /**
     * Metodo que retorna el Score del jugador 2
     * @return Score 2
     */
    ...
    /**
     * Metodo que retorna el Level del juego
     * @return Level
     */
    ...
    /**
     * Metodo que retorna la clase de movimiento de Accion Mul 1
     * @return AccionMul1
     */
    public AccionMul getGameMul1() {
        return game1;
    }

    /**
     * Metodo que retorna la clase de movimiento de Accion Mul 2
     * @return AccionMul2
     */
    public AccionMul getGameMul2() {
        return game2;
    }
